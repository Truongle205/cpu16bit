...
REM
REM Generated by Vivado on Tue Dec 02 12:06:59 +0700 2025
...
echo "xvlog --incr --relax -prj register_file_tb_vlog.prj"
call xvlog  --incr --relax -prj register_file_tb_vlog.prj -log xvlog.log
